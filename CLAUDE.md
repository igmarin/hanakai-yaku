...
`hanakai-yaku` is a curated library of atomic skills and callable agents for the Hanami 2.x Ruby framework. It teaches AI agents how to plan, implement, test, and review Hanami 2.x applications using production-minded conventions.
