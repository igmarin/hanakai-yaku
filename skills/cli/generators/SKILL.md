...
|---|---|
| **hanami-new** | Generators are used after creating the app. |
| **action-anatomy** | Generated Actions need to be filled with logic. |
| **view-objects** | Generated Views need exposures defined. |
| **slice-anatomy** | Generated Slices need routes and configuration. |
| **sequel-migrations** | Generated migrations need schema definitions. |
