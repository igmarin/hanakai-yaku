...
|---|---|
| **hanami-new** | Development commands are used after creating the app. |
| **cli/db-commands** | Database commands may be needed before starting the dev server. |
| **rom-relations** | Use the console to explore and test Relation queries. |
| **rom-repositories** | Use the console to test Repository methods interactively. |
