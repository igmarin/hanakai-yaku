...
| **deps-mixin** | Settings can be injected via `Deps["settings"]`. |
| **slice-configuration** | Slices can define their own settings. |
| **hanami-new** | Generated apps include `config/settings.rb`. Define settings after scaffolding. |
