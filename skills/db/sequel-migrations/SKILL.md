...
6. **Update the ROM Relation** (`skills/db/rom-relations`) to reflect any new
   or removed columns. The Relation schema must stay in sync with the database.

7. **Update Entities and Structs** (`skills/db/rom-structs-entities`) if
