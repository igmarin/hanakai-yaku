...
|---|---|
| **action-anatomy** | Review Action structure and responsibility. |
| **deps-mixin** | Verify proper DI usage. |
| **rom-repositories** | Verify query encapsulation in Repositories. |
| **view-objects** | Verify View simplicity and no DB access. |
| **request-specs** | Verify test coverage for all endpoints. |
