...
|---|---|
| **slice-anatomy** | Configuration follows slice creation. Understand slices before configuring. |
...
| **deps-mixin** | Configured components are injected via `Deps[]`. |
| **new-slice** (workflow) | Full workflow includes configuration step. |
