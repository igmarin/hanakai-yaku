...
|---|---|
| **action-params-validation** | All params must be validated before use. |
| **action-halt-errors** | Error responses must not leak sensitive information. |
...
| **authentication-workflow** | For implementing auth strategies. |
