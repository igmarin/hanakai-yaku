...
|---|---|
| **request-specs** | Write request specs for full-stack HTTP behavior. |
| **action-unit-specs** | Write action unit specs for isolated Action logic. |
| **rom-specs** | Write ROM specs for Relation and Repository testing. |
| **tdd-workflow** | Follow the full TDD workflow: plan → test → implement → review. |
